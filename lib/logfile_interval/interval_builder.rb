module LogfileInterval
  class IntervalBuilder
    ...
    def each_interval(&block)
      ...
      current_interval = init_first_interval
    ...
    def init_first_interval
      case order
      when :asc  then init_first_interval_ascending
      when :desc then init_first_interval_descending
      else raise 'unknown enumerator order'
      end
    end

    def init_first_interval_ascending
    ...
    def init_first_interval_descending
